               ...
               children: <Widget>[
                Center(
                  child: Column(
                    ...
                    SizedBox(height: 20),
                    Text(snapshot.data.documents[widget.index]['title'],style: TextStyle(color:Colors.green[600], fontSize: 40)),
                    SizedBox(height: 30,),
                    Text (snapshot.data.documents[widget.index]['description'],style: TextStyle(color:Colors.green[600], fontSize: 20)),
                    SizedBox(height: 30,),
                    Text ("Serving Size:", style: TextStyle(color: Colors.green, fontSize:30)),
                    Text (snapshot.data.documents[widget.index]['amount'],style: TextStyle(color:Colors.black, fontSize: 20)),
                    SizedBox(height: 20,),
                    Text ("Date and Time:", style: TextStyle(color: Colors.green, fontSize:30)),
                    ...
                    SizedBox(height: 20,),
                    Text ("Location:", style: TextStyle(color: Colors.green, fontSize:30)),
